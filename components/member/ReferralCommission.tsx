					...
					<div className="mb-4">
						...
						<p className="dark:text-gray-300">Unique Referral Code: {member.memberId} </p>
							<button 
								...
								className=""
								>
								{codeCopied ? <Check className="h-4 w-4 text-[#B39665] hover:text-[#C4A777] transition-colors" /> : <Copy className="h-4 w-4 text-[#B39665] hover:text-[#C4A777] transition-colors" />}
							</button>
						</div>
						<div className="flex flex-col sm:flex-row gap-2">
