                    ...
                    <div className='w-[80%] mx-auto grid xl:grid-cols-3 items-center gap-20'> {/* Added `grid` class */}
                        <div className='xl:col-span-1 mt-6'>
                            ...
                            <p className='text-base text-white text-opacity-50 mt-6'>
                                At our villas, we pride ourselves on providing an exceptional experience
                                that exceeds expectations. Here’s what our guests have to say about their
                                stay in our exclusive properties, where luxury, comfort, and unforgettable
                                memories come together. Discover why travelers around the world trust us
                                with their dream vacations.
                            </p>
                            <div className='flex items-center space-x-10 mt-8'>
                                <p className='text-white font-bold text-5xl'>99%</p>
                                <p className='text-white'>
                                    of guests would recommend our villas for an unforgettable stay. <br />
                                </p>
                            </div>
                        </div>
